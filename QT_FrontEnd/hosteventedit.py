...
"")
        ...
        self.EventIamge2 = QtWidgets.QGraphicsView(HostEventEdit)
        self.EventIamge2.setGeometry(QtCore.QRect(317, 340, 131, 81))
        font = QtGui.QFont()
        font.setPointSize(16)
...
"")
    ...
    def retranslateUi(self, HostEventEdit):
        ...
        self.MonthComboBox.setItemText(1, _translate("HostEventEdit", "1"))
        self.MonthComboBox.setItemText(2, _translate("HostEventEdit", "2"))
        self.MonthComboBox.setItemText(3, _translate("HostEventEdit", "3"))
        self.MonthComboBox.setItemText(4, _translate("HostEventEdit", "4"))
        self.MonthComboBox.setItemText(5, _translate("HostEventEdit", "5"))
        self.MonthComboBox.setItemText(6, _translate("HostEventEdit", "6"))
        self.MonthComboBox.setItemText(7, _translate("HostEventEdit", "7"))
        self.MonthComboBox.setItemText(8, _translate("HostEventEdit", "8"))
        self.MonthComboBox.setItemText(9, _translate("HostEventEdit", "9"))
        ...
        self.DayComboBox.setItemText(1, _translate("HostEventEdit", "1"))
        self.DayComboBox.setItemText(2, _translate("HostEventEdit", "2"))
        self.DayComboBox.setItemText(3, _translate("HostEventEdit", "3"))
        self.DayComboBox.setItemText(4, _translate("HostEventEdit", "4"))
        self.DayComboBox.setItemText(5, _translate("HostEventEdit", "5"))
        self.DayComboBox.setItemText(6, _translate("HostEventEdit", "6"))
        self.DayComboBox.setItemText(7, _translate("HostEventEdit", "7"))
        self.DayComboBox.setItemText(8, _translate("HostEventEdit", "8"))
        self.DayComboBox.setItemText(9, _translate("HostEventEdit", "9"))
