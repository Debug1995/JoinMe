...
post_button = Button(window, text="Post Event", command=postEvent)
post_button.place(x=90,y=240)

update_button = Button(window, text="Update Event", command=updateEvent)
...
userID_input.place(x=240,y=265)

remove_button = Button(window, text="Remove User", command=removeUser)
...
User_Realname = Label(window, text = 'Realname:')
...
updateProfile_button = Button(window, text="Update Profile", command=updateProfile)
